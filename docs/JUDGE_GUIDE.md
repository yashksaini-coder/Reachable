...
1. Open the console — <https://reachable-lac.vercel.app> (read-only deploy of the committed reports; landing first, **Incidents** is `/incidents`) — or `make up` → http://localhost:3000 for the live version → click **MAL-2025-46974** (debug@4.4.2).
