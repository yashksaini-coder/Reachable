...
export function ExportButton() {
  ...
  return (
    <button
      type="button"
      onClick={go}
      className="ml-auto inline-flex min-h-10 items-center justify-center gap-2 rounded-md border border-border px-3 text-[11.5px] font-medium leading-none text-mut transition-[color,background-color,transform] duration-[180ms] ease-[var(--ease)] hover:bg-hover hover:text-fg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-signal/50 active:scale-[0.97] max-[600px]:ml-0 max-[600px]:mt-1 max-[600px]:w-full print:hidden"
    >
