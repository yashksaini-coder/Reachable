  ...
  return (
    <div className="min-h-dvh bg-bg">
      <header className="sticky top-0 z-40 border-b border-border bg-bg/[.92] backdrop-blur-[8px]">
        <div className="mx-auto flex h-[52px] max-w-[1280px] items-center gap-3 px-10 max-[900px]:px-5">
          ...
          <span className="text-[12.5px] leading-none text-mut">guide</span>
          <Link
            href="/incidents"
            className="ml-auto inline-flex min-h-10 items-center gap-1.5 rounded-lg border border-border px-3 text-[12px] font-medium leading-none text-mut transition-colors duration-[180ms] ease-[var(--ease)] hover:bg-hover hover:text-fg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-signal/50"
          >
